...
// */
//class CreateLogicalResources @JsonConstructor constructor(private val params: RpcStartFlowRequestParameters) : Flow<LogicalResources> {
//
//    @CordaInject
...
//
//    val commercialBankName = with(mapOfParams["commercialBankName"] ?: throw BadRpcStartFlowRequestException("Template State Parameter \"commercialBankName\" missing.")) {
//        this
//    }
//    val pipName = with(mapOfParams["pipName"] ?: throw BadRpcStartFlowRequestException("Template State Parameter \"pipName\" missing.")) {
//        this
//    }
//
//
